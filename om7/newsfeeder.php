...
$settings['news_table'] = XOOPS_DB_PREFIX."_stories"; // db table name of news
$settings['news_title_cell'] = "title"; // table cell with title
$settings['news_id_cell'] = "storyid"; // table cell with ID number used in Link
$settings['news_linkbody'] = XOOPS_URL."/modules/news/article.php?storyid="; // static part of link
